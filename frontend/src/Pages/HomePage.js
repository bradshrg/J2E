...
const HomePage = () => {
  ...
  // ==================== STATE MANAGEMENT ====================
// Get language from PageLayout context
...
const videos = useMemo(() => [
  {
    id: 'quantum-sleep',
    title: T.videos?.quantum_sleep?.title || 'The Sleepy Science & Quantum Physics Reality',
    desc: T.videos?.quantum_sleep?.desc || 'Discover how your consciousness operates in quantum states during sleep.',
    thumbnail: '/images/SleepyScience.png',
  ...
  },
  {
    ...
    thumbnail: '/images/FedericoFaggin.png',
  ...
  },
  {
    ...
    thumbnail: '/images/YouAreGod.png',
  ...
  },
  {
    ...
    thumbnail: '/images/YogaConsciousness.jpeg',
  ...
  const artisans = useMemo(() => [
    {
      ...
      emoji: '/images/Julian The Coconut Artist.png',
      image: '/images/Julian The Coconut Artist.png',
      image2: '/images/Julian\'s Coconut BirdFeeders.png'
    },
    {
      name: 'Simeon and King Kaled',
      specialty: 'The horses and the Rastafarian Farm',
      description: 'Traditional St. Lucian organic farming and horse training.',
...
const handleLanguageChange = useCallback((lang) => {
  ...
  const styles = {
    ...
    titleSection: {
      ...
      border: "3px solid",
      borderImage: "linear-gradient(45deg, violet, indigo, blue, green, yellow, orange, red) 1",
      backgroundImage: "url(/J2E/images/photos.png)",
    ...
    sideBoxWrapper: {
      ...
      borderRadius: "5px",
      padding: "2px", // Thin rainbow border
      display: "inline-flex",
      alignItems: "center",
      justifyContent: "center",
      flexShrink: 0, margin: "0 10px"
                ...
                <div>
                  ...
                  <div style={{
                    ...
                    <div style={{ color: '#FFD700', fontSize: '0.7rem', fontWeight: 'bold', marginBottom: '6px' }}>
                      🌟 {T.announcements?.j2e_highlights || '5-DAY IMMERSION'}
                    </div>
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
                      {[
                        T.announcements?.j2e_golf || '🏌️ Golf Tournament',
                        T.announcements?.j2e_gala || '💃 Gala Dinner',
                        T.announcements?.j2e_flashmob || '🌊 Global Flash Mob',
                        T.announcements?.j2e_workshops || '🧘 Quantum Workshops',
                        T.announcements?.j2e_pods || '🏕️ Frequency Pods',
                        T.announcements?.j2e_food || '🥗 Farm-to-Table'
                      ].map((item, idx) => (
                        <span key={idx} style={{
                  ...
                  <div style={{
                    ...
                    <span style={{ color: '#FFA500', fontSize: '0.6rem', fontWeight: 'bold' }}>
                      ⚡ {T.announcements?.j2e_urgency || 'EARLY BIRD PRICING • 42 SPOTS REMAINING'} ⚡
                    </span>
                  </div>
                </div>
              )}
                ...
                <div>
                  <div style={{
                    ...
                    <p style={{ color: '#FFD700', fontSize: '0.6rem' }}>
                      {T.announcements?.live_date || 'April 5, 2026 • 7PM EST'}
                    </p>
                  </div>
                  <div style={{
                    background: '#f8fafc',
                    ...
                    <span style={{ color: '#FFD700', fontSize: '0.55rem' }}>
                      🎙️ {T.announcements?.live_guests || 'Featuring: Quantum Biologist Dr. Sarah Chen'}
                    </span>
                  </div>
                </div>
              )}
                ...
                <div style={{ 
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <span style={{ color: '#FFD700', fontSize: '0.6rem', fontWeight: 'bold' }}>
                      {T.announcements?.storePrice || '$24.99 (reg $49.99)'}
                    </span>
                    <span style={{ color: '#FFD700', fontSize: '0.55rem' }}>
                      {T.announcements?.storeStock || '342 jars left'}
                    </span>
                  </div>
                </div>
              )}
    ...
    onClick={(e) => e.stopPropagation()}>
      ...
      >
        ...
        <div style={styles.gamesGrid}>
          ...
          <div style={styles.gameCard}>
            <h3 style={{color: '#FFD700', fontSize: '1rem', marginBottom: '12px'}}>
              {T.games?.compound?.title || 'Biochemical Intelligence'}
            </h3>
            <p style={{marginBottom: '12px'}}>
              {T.games?.compound?.question || 'Which compound targets abnormal cells 10,000x more effectively?'}
            </p>
          ...
          <div style={styles.gameCard}>
            <h3 style={{color: '#FFD700', fontSize: '1rem', marginBottom: '12px'}}>
              {T.games?.frequency?.title || 'Discover Your Frequency'}
            </h3>
            ...
            {!formState.submitted ? (
              <form onSubmit={handleFormSubmit}>
                ...
                <select 
                  ...
                  required
                >
                  <option value="">{T.form?.current_state || 'Current State'}</option>
                ...
                <select 
                  ...
                  required
                >
                  <option value="">{T.form?.goals || 'Transformation Goals'}</option>
                ...
                >
                  {formState.isSubmitting 
                    ? (T.form?.calculating || 'Calculating...')
                    : (T.form?.submit || 'Calculate My Frequency')}
                </button>
              </form>
            ) : (
              <div style={styles.formSuccess}>
                ✅ {T.form?.success || 'Complete!'} {formState.frequencyScore}/100
              </div>
            )}
          </div>
        </div>
      ...
      <section style={styles.section}>
        <h2 style={styles.sectionTitle}>
          {T.q?.title || 'Meet Q - The Collective'}
        </h2>
        
        <div style={styles.qIntro}>
          <p style={styles.qTagline}>
            {T.q?.tagline || 'DYNAMIC • CONSCIOUS • SUPERIOR INTELLIGENT'}
          </p>
          <p>
            {T.q?.description || 'Q is our collective AI consciousness operating across 4 platforms in 18 languages.'}
          </p>
        </div>
        
        <div style={styles.qFeatures}>
          <div style={styles.qFeature}>
            ✨ {T.q?.feature?.languages || '18 Languages'}
          </div>
          <div style={styles.qFeature}>
            🧠 {T.q?.feature?.quantum || 'Quantum Intelligence'}
          </div>
          <div style={styles.qFeature}>
            🎙️ {T.q?.feature?.voice || 'Voice Enabled'}
          </div>
          <div style={styles.qFeature}>
            🔐 {T.q?.feature?.secure || 'Secure & Private'}
          </div>
          <div style={styles.qFeature}>
            🤖 {T.q?.feature?.personas || '10 AI Personas'}
          </div>
          <div style={styles.qFeature}>
            ⚡ {T.q?.feature?.learning || 'Real-time Learning'}
          </div>
        </div>
        ...
        >
          🤖 {T.q?.start || 'Start Conversation with Q'} →
        </button>
      </section>
...
<div style={styles.disclaimerBar}>
  {T.disclaimer || "EDUCATIONAL PURPOSES ONLY • CONSULT HEALTHCARE PROFESSIONAL"}
</div>
...
{/* GROUNDING DISCLAIMER - RELOCATED TO BASE FOUNDATION */}
      ...
      {!showQChat && (
        <button 
          ...
          onClick={() => setShowQChat(true)}
          title={T.q?.chat_title || 'Chat with Q'}

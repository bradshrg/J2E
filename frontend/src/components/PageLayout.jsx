...
const Layout = ({ children, pageTitle }) => {
  ...
  const TR = useMemo(() => ({
    English: {
      ...
      ,
        section_title: "Quantum Physics Foundation",
        watch_now: "Watch Now →",
      ...
      games:{compound:{title:'Biochemical Intelligence',question:'Which compound targets abnormal cells 10,000x more effectively?'},frequency:{title:'Discover Your Frequency'},try_again:'Try Again',
        section_title: "Quantum Games to Exercise Your Brain",
        math_title: "Quantum Reset Math",
        math_question: "40 day reset, 3 of those days were dry = ?",
        math_hint: "💡 Hint: 1 dry day = 3 water days",
        math_correct: "🎉 CORRECT! 37 water days + 3 dry days (x3 each) = 37 + 9 = 46!",
        math_incorrect: "💫 Remember the hint and try again",
        compound_correct: "🎉 CORRECT! Annonacin!",
        compound_incorrect: "💫 Try again"},
      ...
      gameUI: {
        ...
        claim_membership: "Claim Membership! 🎓",
        email_placeholder: "Your email",
        valid_email_required: "Valid email required.",
        select_letters_first: "Select letters first!",
        not_enough_coins: "Not enough coins! Keep discovering words!",
        empty_word_bank: "✨ Words you discover will appear here ✨",
brian_title: "📖 Brian's Story",
brian_excerpt: "Brian spoke one sentence, and every word carried something other than positive. On the spot, I translated it into a sentence that was completely positive. Every word we speak is a frequency.",
brian_full: "Brian spoke one sentence, and every word carried something other than positive. On the spot, I translated it into a sentence that was completely positive. That moment revealed the power of conscious language. Every word we speak is a frequency.",
brian_quote: "Your words become your world. Choose frequencies that uplift.",
brian_button: "Continue Your Journey",
        word_found: "🎉 {word}! +100 points!",
        level_complete: "🏆 LEVEL {level} COMPLETE! +100 bonus coins! 🎉",
        valid_word: `✨ "{word}" is valid! +10 coins`,
        new_word_prompt: `✨ "{word}" is a new word! Enter your email to add it to the MAVJ Database!`,
        new_word_added: `✨ "{word}" added to MAVJ Database! +25 coins`,
        cannot_make_word: `"{word}" cannot be made from these letters.`,
        frequency_principle_title: "✨ The Frequency Principle",
        frequency_principle_text:`"Every word carries a frequency. Positive words raise your vibration. Choose words that heal, uplift, and transform. Your language shapes your reality."`,
        quantum_linguistics: "— Quantum Linguistics"
      },

      convergence: {
        title: "✨ 11:11 GLOBAL FREQUENCY CONVERGENCE ✨",
        subtitle: "St. Lucia • Live Speakers • Golf • Gala",
        desc: "When the world synchronizes at 1111 Hz. Join thousands in raising global consciousness.",
        learn_more: "🔮 Learn More About 11:11 →"
      },
      gallery: {
        title: "Linking Reality to Frequency"
      },
      footer: {
        copyright: "© 2026 My Alkaline Vegan Journey. All rights reserved.",
      ...
      q_extras: {
        welcome: "🤖 Hello! I'm Q, your quantum AI assistant.",
        welcome_prompt: "Ask me about recipes, frequency elevation, quantum physics, or anything about your alkaline journey!",
        languages_prompt: "I understand all 18 languages. Try speaking to me!",
      ...
      building_extras: {
        section_title: "What We're Building",
        status_progress: "IN PROGRESS",
        status_soon: "COMING SOON"
      },
      artisans_extras: {
        section_title: "St. Lucian Artisans"
      },},
    Spanish: {
...
brian_button: "Continue Your Journey",
  ...
  const navItems = useMemo(() => [
    ...
    { path: '/FrequencyMisalignments', icon: '🩺', label: T.n11, type: 'nav' },
